ig.module('game.entities.buttons.button-prev')
	.requires(
	...
	.defines(function () {
		EntityButtonPrev = EntityButton.extend({
			...
			zIndex:_DATAGAME.zIndexData.buttonPrev,
			gap:{x:0, y:0},
			image:new ig.Image(_RESOURCESINFO.image.btnPrev),
			defsize: {
	        ...
	        funcComplete:function() {
				...
				if(this._parent.pageNow < 1) this._parent.pageNow = this._parent.totalPage;
