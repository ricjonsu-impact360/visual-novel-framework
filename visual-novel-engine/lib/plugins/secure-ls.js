...
.requires("plugins.io.fake-storage")
.defines(function() {
    (function() {
        !function(t, e) {
            "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define("SecureLS", [], e) : "object" == typeof exports ? exports.SecureLS = e() : t.SecureLS = e()
        }(this, function() {
            return function(t) {
                function e(i) {
                    if (r[i])
                ...
                var o = function() {
                  ...
                  , C = function() {
                    function t(e) {
                        ...
                        this.Base64 = p["default"],
                        this.LZString = y["default"],
                        this.AES = _["default"],
                        this.DES = S["default"],
                        this.RABBIT = k["default"],
                        this.RC4 = E["default"],
                        this.enc = f["default"],
                        this.config = {
                            isCompression: !0,
                            encodingType: u["default"].EncrytionTypes.BASE64,
                            encryptionSecret: e.encryptionSecret,
                            encryptionNamespace: e.encryptionNamespace
                        },
                        this.config.isCompression = "undefined" == typeof e.isCompression || e.isCompression,
                        this.config.encodingType = "undefined" != typeof e.encodingType || "" === e.encodingType ? e.encodingType.toLowerCase() : u["default"].EncrytionTypes.BASE64;
                        try {
                    ...
                    return o(t, [{
                        ...
                        value: function() {
                            return p["default"] && ("undefined" == typeof this.config.encodingType || this.config.encodingType === this.constants.EncrytionTypes.BASE64)
                        }
                    }, {
                        key: "_isAESEncryptionType",
                        value: function() {
                            return _["default"] && this.config.encodingType === this.constants.EncrytionTypes.AES
                        }
                    }, {
                        key: "_isDESEncryptionType",
                        value: function() {
                            return S["default"] && this.config.encodingType === this.constants.EncrytionTypes.DES
                        }
                    }, {
                        key: "_isRabbitEncryptionType",
                        value: function() {
                            return k["default"] && this.config.encodingType === this.constants.EncrytionTypes.RABBIT
                        }
                    }, {
                        key: "_isRC4EncryptionType",
                        value: function() {
                            return E["default"] && this.config.encodingType === this.constants.EncrytionTypes.RC4
                        }
                    }, {
                        ...
                        value: function(t) {
                            ...
                            r && (this._isAES || this._isDES || this._isRabbit || this._isRC4) && ("undefined" == typeof this.config.encryptionSecret ? (this.utils.encryptionSecret = r.s,
                            this.utils.encryptionSecret || (this.utils.encryptionSecret = this.utils.generateSecretKey(),
                            this.setMetaData())) : this.utils.encryptionSecret = this.config.encryptionSecret || r.s || "")
                        }
                    }, {
                        key: "get",
                        value: function(t, e) {
                            ...
                            if (!this.utils.is(t))
                                ...
                                i;
                            if (s = this.getDataFromLocalStorage(t),
                            !s)
                                return i;
                            n = s,
                            (this._isCompression || e) && (n = y["default"].decompressFromUTF16(s)),
                            r = n,
                            this._isBase64 || e ? r = p["default"].decode(n) : (this.getEncryptionSecret(t),
                            this._isAES ? o = _["default"].decrypt(n.toString(), this.utils.encryptionSecret) : this._isDES ? o = S["default"].decrypt(n.toString(), this.utils.encryptionSecret) : this._isRabbit ? o = k["default"].decrypt(n.toString(), this.utils.encryptionSecret) : this._isRC4 && (o = E["default"].decrypt(n.toString(), this.utils.encryptionSecret)),
                            o && (r = o.toString(f["default"]._Utf8)));
                            try {
                                i = JSON.parse(r)
                            } catch (a) {
                        ...
                        value: function(t, e) {
                            var r = "";
                            return this.utils.is(t) ? (this.getEncryptionSecret(t),
                            String(t) !== String(this.utils.metaKey) && (this.utils.isKeyPresent(t) || (this.utils.addToKeysList(t),
                            this.setMetaData())),
                            r = this.processData(e),
                            void this.setDataToLocalStorage(t, r)) : void this.utils.warn(this.WarningEnum.KEY_NOT_PROVIDED)
                        }
                    }, {
                        ...
                        key: "remove",
                        value: function(t) {
                            return this.utils.is(t) ? t === this.utils.metaKey && this.getAllKeys().length ? void this.utils.warn(this.WarningEnum.META_KEY_REMOVE) : (this.utils.isKeyPresent(t) && (this.utils.removeFromKeysList(t),
                            this.setMetaData()),
                            void this.ls.removeItem(t)) : void this.utils.warn(this.WarningEnum.KEY_NOT_PROVIDED)
                        }
                    }, {
                        key: "removeAll",
                        value: function() {
                        ...
                        value: function(t, e) {
                            ...
                            return i = r,
                            this._isBase64 || e ? i = p["default"].encode(r) : (this._isAES ? i = _["default"].encrypt(r, this.utils.encryptionSecret) : this._isDES ? i = S["default"].encrypt(r, this.utils.encryptionSecret) : this._isRabbit ? i = k["default"].encrypt(r, this.utils.encryptionSecret) : this._isRC4 && (i = E["default"].encrypt(r, this.utils.encryptionSecret)),
                            i = i && i.toString()),
                            n = i,
                            (this._isCompression || e) && (n = y["default"].compressToUTF16(i)),
                            n
                        }
                    }, {
                        key: "setMetaData",
            ...
            , function(t, e, r) {
                ...
                var n = r(2)
                  ...
                  , h = {
                    ...
                    warn: function(t) {
                        t = t ? t : o["default"].WarningEnum.DEFAULT_TEXT,
                        console.warn(o["default"].WarningTypes[t])
                    },
                    generateSecretKey: function() {
                        var t = a["default"].random(16)
                          , e = (0,
                        u["default"])(this.secretPhrase, t, {
                            keySize: 4
                        });
                        return e && e.toString()
                    },
                    ...
                    extractKeyNames: function(t) {
                        return t && t.keys && t.keys.length ? t.keys.map(function(t) {
                            return t.k
                        }) : []
                    },
                    getAllKeys: function() {
                    ...
                    removeFromKeysList: function(t) {
                        ...
                        return r !== -1 && this.allKeys.splice(r, 1),
                        r
                    }
                };
                t.exports = h
            ...
            , function(t, e) {
                ...
                var r = {
                  ...
                  , i = {};
                i[r.KEY_NOT_PROVIDED] = "Secure LS: Key not provided. Aborting operation!",
                i[r.META_KEY_REMOVE] = "Secure LS: Meta key can not be removed\nunless all keys created by Secure LS are removed!",
            ...
            , function(t, e) {
                ...
                r.random = function(t) {
                    for (var e, r = [], i = function(t) {
                        ...
                        var o = i(4294967296 * (e || Math.random()));
                        e = 987654071 * o(),
                        ...
                        var e = t
                          ...
                          , c = o.PBKDF2 = i.extend({
                            ...
                            compute: function(t, e) {
                                for (var r = this.cfg, i = a.create(r.hasher, t), o = n.create(), s = n.create([1]), c = o.words, u = s.words, h = r.keySize, f = r.iterations; c.length < h; ) {
                                    var l = i.update(e).finalize(s);
                                    i.reset();
                                    for (var p = l.words, d = p.length, y = l, v = 1; v < f; v++) {
                                        y = i.finalize(y),
                                        i.reset();
                                        for (var _ = y.words, g = 0; g < d; g++)
                                            p[g] ^= _[g]
                                    }
                                    o.concat(l),
                                    u[0]++
                    ...
                    var t = t || function(t, e) {
                        var r = Object.create || function() {
                          ...
                          , s = n.WordArray = o.extend({
                            init: function(t, r) {
                                t = this.words = t || [],
                                r != e ? this.sigBytes = r : this.sigBytes = 4 * t.length
                            },
                            toString: function(t) {
                        ...
                        var e = t
                          ...
                          , a = o.SHA1 = n.extend({
                            ...
                            _doProcessBlock: function(t, e) {
                                for (var r = this._hash.words, i = r[0], n = r[1], o = r[2], a = r[3], c = r[4], u = 0; u < 80; u++) {
                                    if (u < 16)
                                        s[u] = 0 | t[e + u];
                                    else {
                                    ...
                                    var f = (i << 5 | i >>> 27) + c + s[u];
                                    f += u < 20 ? (n & o | ~n & a) + 1518500249 : u < 40 ? (n ^ o ^ a) + 1859775393 : u < 60 ? (n & o | n & a | o & a) - 1894007588 : (n ^ o ^ a) - 899497514,
                                    c = a,
                                    a = o,
                                    o = n << 30 | n >>> 2,
                                    n = i,
                    ...
                    !function() {
                        ...
                        s.HMAC = i.extend({
                            init: function(t, e) {
                                ...
                                e.clamp();
                                for (var n = this._oKey = e.clone(), s = this._iKey = e.clone(), a = n.words, c = s.words, u = 0; u < r; u++)
                                    a[u] ^= 1549556828,
                                    c[u] ^= 909522486;
                ...
                var r = {
                    ...
                    encode: function(t) {
                        ...
                        for (t = r._utf8Encode(t); h < t.length; )
                            ...
                            e = e + this._keyStr.charAt(s) + this._keyStr.charAt(a) + this._keyStr.charAt(c) + this._keyStr.charAt(u);
                        return e
                    },
                    decode: function(t) {
                        var e = ""
                        ...
                        for (t = t.replace(/[^A-Za-z0-9\+\/\=]/g, ""); h < t.length; )
                            ...
                            u = this._keyStr.indexOf(t.charAt(h++)),
                            i = s << 2 | a >> 4,
                            n = (15 & a) << 4 | c >> 2,
                            o = (3 & c) << 6 | u,
                            e += String.fromCharCode(i),
                            64 !== c && (e += String.fromCharCode(n)),
                            64 !== u && (e += String.fromCharCode(o));
                    ...
                    _utf8Decode: function(t) {
                        ...
                        for (i = n = 0; r < t.length; )
                            ...
                            r++) : i > 191 && i < 224 ? (n = t.charCodeAt(r + 1),
                            e += String.fromCharCode((31 & i) << 6 | 63 & n),
                            r += 2) : (n = t.charCodeAt(r + 1),
                            o = t.charCodeAt(r + 2),
                    ...
                    var e = String.fromCharCode
                      ...
                      , o = {
                        ...
                        decompressFromBase64: function(e) {
                            return null == e ? "" : "" == e ? null : o._decompress(e.length, 32, function(i) {
                                return t(r, e.charAt(i))
                            })
                        },
                        ...
                        decompressFromUint8Array: function(t) {
                            ...
                            for (var r = new Array(t.length / 2), i = 0, n = r.length; i < n; i++)
                                r[i] = 256 * t[2 * i] + t[2 * i + 1];
                            var s = [];
                        ...
                        _compress: function(t, e, r) {
                            if (null == t)
                                return "";
                            var i, n, o, s = {}, a = {}, c = "", u = "", h = "", f = 2, l = 3, p = 2, d = [], y = 0, v = 0;
                            for (o = 0; o < t.length; o += 1)
                                if (c = t.charAt(o),
                                Object.prototype.hasOwnProperty.call(s, c) || (s[c] = l++,
                                a[c] = !0),
                                u = h + c,
                        ...
                        _decompress: function(t, r, i) {
                            var n, o, s, a, c, u, h, f, l = [], p = 4, d = 4, y = 3, v = "", _ = [], g = {
                                val: i(0),
                                position: r,
                                index: 1
                            };
            ...
            , function(t, e, r) {
                !function(i, n, o) {
                    t.exports = e = n(r(5), r(12), r(13), r(14), r(15))
                }(this, function(t) {
                    return function() {
                        var e = t
                          , r = e.lib
                        ...
                        !function() {
                            ...
                            for (var r = 0, i = 0, e = 0; e < 256; e++) {
                                ...
                                u[r] = g << 8 | g >>> 24,
                                h[r] = g;
                                var g = 16843009 * _ ^ 65537 * v ^ 257 * y ^ 16843008 * r;
                                f[n] = g << 24 | g >>> 8,
                                l[n] = g << 16 | g >>> 16,
                                p[n] = g << 8 | g >>> 24,
                                d[n] = g,
                                ...
                                if (!this._nRounds || this._keyPriorReset !== this._key) {
                                    ...
                                    for (var u = this._invKeySchedule = [], h = 0; h < n; h++) {
                                        ...
                                        if (h % 4)
                                            ...
                                            var c = s[a - 4];
                                        h < 4 || a <= 4 ? u[h] = c : u[h] = f[o[c >>> 24]] ^ l[o[c >>> 16 & 255]] ^ p[o[c >>> 8 & 255]] ^ d[o[255 & c]]
                                    }
                                }
                            },
                            encryptBlock: function(t, e) {
                                this._doCryptBlock(t, e, this._keySchedule, a, c, u, h, o)
                            },
                            decryptBlock: function(t, e) {
                                var r = t[e + 1];
                                t[e + 1] = t[e + 3],
                                t[e + 3] = r,
                                this._doCryptBlock(t, e, this._invKeySchedule, f, l, p, d, s);
                                var r = t[e + 1];
                                t[e + 1] = t[e + 3],
                                t[e + 3] = r
                            },
                            _doCryptBlock: function(t, e, r, i, n, o, s, a) {
                                for (var c = this._nRounds, u = t[e] ^ r[0], h = t[e + 1] ^ r[1], f = t[e + 2] ^ r[2], l = t[e + 3] ^ r[3], p = 4, d = 1; d < c; d++) {
                                    var y = i[u >>> 24] ^ n[h >>> 16 & 255] ^ o[f >>> 8 & 255] ^ s[255 & l] ^ r[p++]
                                      , v = i[h >>> 24] ^ n[f >>> 16 & 255] ^ o[l >>> 8 & 255] ^ s[255 & u] ^ r[p++]
                                      , _ = i[f >>> 24] ^ n[l >>> 16 & 255] ^ o[u >>> 8 & 255] ^ s[255 & h] ^ r[p++]
                                      , g = i[l >>> 24] ^ n[u >>> 16 & 255] ^ o[h >>> 8 & 255] ^ s[255 & f] ^ r[p++];
                                    u = y,
                                    h = v,
                                    f = _,
                                    l = g
                                }
                                var y = (a[u >>> 24] << 24 | a[h >>> 16 & 255] << 16 | a[f >>> 8 & 255] << 8 | a[255 & l]) ^ r[p++]
                                  , v = (a[h >>> 24] << 24 | a[f >>> 16 & 255] << 16 | a[l >>> 8 & 255] << 8 | a[255 & u]) ^ r[p++]
                                  , _ = (a[f >>> 24] << 24 | a[l >>> 16 & 255] << 16 | a[u >>> 8 & 255] << 8 | a[255 & h]) ^ r[p++]
                                  , g = (a[l >>> 24] << 24 | a[u >>> 16 & 255] << 16 | a[h >>> 8 & 255] << 8 | a[255 & f]) ^ r[p++];
                                t[e] = y,
                                t[e + 1] = v,
                                t[e + 2] = _,
                                t[e + 3] = g
                        ...
                        o.Base64 = {
                            stringify: function(t) {
                                ...
                                for (var n = [], o = 0; o < r; o += 3)
                                    for (var s = e[o >>> 2] >>> 24 - o % 4 * 8 & 255, a = e[o + 1 >>> 2] >>> 24 - (o + 1) % 4 * 8 & 255, c = e[o + 2 >>> 2] >>> 24 - (o + 2) % 4 * 8 & 255, u = s << 16 | a << 8 | c, h = 0; h < 4 && o + .75 * h < r; h++)
                                        n.push(i.charAt(u >>> 6 * (3 - h) & 63));
                                var f = i.charAt(64);
                                if (f)
                                    for (; n.length % 4; )
                                        n.push(f);
            ...
            , function(t, e, r) {
                !function(i, n) {
                    ...
                    return function(e) {
                        ...
                        var l = h.MD5 = u.extend({
                            ...
                            _doProcessBlock: function(t, e) {
                                ...
                                var u = this._hash.words
                                  ...
                                  , T = u[3];
                                w = r(w, b, D, T, h, 7, f[0]),
                                T = r(T, w, b, D, l, 12, f[1]),
                                D = r(D, T, w, b, p, 17, f[2]),
                                b = r(b, D, T, w, d, 22, f[3]),
                                w = r(w, b, D, T, y, 7, f[4]),
                                T = r(T, w, b, D, v, 12, f[5]),
                                D = r(D, T, w, b, _, 17, f[6]),
                                b = r(b, D, T, w, g, 22, f[7]),
                                w = r(w, b, D, T, S, 7, f[8]),
                                T = r(T, w, b, D, m, 12, f[9]),
                                D = r(D, T, w, b, k, 17, f[10]),
                                b = r(b, D, T, w, B, 22, f[11]),
                                w = r(w, b, D, T, E, 7, f[12]),
                                T = r(T, w, b, D, C, 12, f[13]),
                                D = r(D, T, w, b, x, 17, f[14]),
                                b = r(b, D, T, w, A, 22, f[15]),
                                w = i(w, b, D, T, l, 5, f[16]),
                                T = i(T, w, b, D, _, 9, f[17]),
                                D = i(D, T, w, b, B, 14, f[18]),
                                b = i(b, D, T, w, h, 20, f[19]),
                                w = i(w, b, D, T, v, 5, f[20]),
                                T = i(T, w, b, D, k, 9, f[21]),
                                D = i(D, T, w, b, A, 14, f[22]),
                                b = i(b, D, T, w, y, 20, f[23]),
                                w = i(w, b, D, T, m, 5, f[24]),
                                T = i(T, w, b, D, x, 9, f[25]),
                                D = i(D, T, w, b, d, 14, f[26]),
                                b = i(b, D, T, w, S, 20, f[27]),
                                w = i(w, b, D, T, C, 5, f[28]),
                                T = i(T, w, b, D, p, 9, f[29]),
                                D = i(D, T, w, b, g, 14, f[30]),
                                b = i(b, D, T, w, E, 20, f[31]),
                                w = n(w, b, D, T, v, 4, f[32]),
                                T = n(T, w, b, D, S, 11, f[33]),
                                D = n(D, T, w, b, B, 16, f[34]),
                                b = n(b, D, T, w, x, 23, f[35]),
                                w = n(w, b, D, T, l, 4, f[36]),
                                T = n(T, w, b, D, y, 11, f[37]),
                                D = n(D, T, w, b, g, 16, f[38]),
                                b = n(b, D, T, w, k, 23, f[39]),
                                w = n(w, b, D, T, C, 4, f[40]),
                                T = n(T, w, b, D, h, 11, f[41]),
                                D = n(D, T, w, b, d, 16, f[42]),
                                b = n(b, D, T, w, _, 23, f[43]),
                                w = n(w, b, D, T, m, 4, f[44]),
                                T = n(T, w, b, D, E, 11, f[45]),
                                D = n(D, T, w, b, A, 16, f[46]),
                                b = n(b, D, T, w, p, 23, f[47]),
                                w = o(w, b, D, T, h, 6, f[48]),
                                T = o(T, w, b, D, g, 10, f[49]),
                                D = o(D, T, w, b, x, 15, f[50]),
                                b = o(b, D, T, w, v, 21, f[51]),
                                w = o(w, b, D, T, E, 6, f[52]),
                                T = o(T, w, b, D, d, 10, f[53]),
                                D = o(D, T, w, b, k, 15, f[54]),
                                b = o(b, D, T, w, l, 21, f[55]),
                                w = o(w, b, D, T, S, 6, f[56]),
                                T = o(T, w, b, D, A, 10, f[57]),
                                D = o(D, T, w, b, _, 15, f[58]),
                                b = o(b, D, T, w, C, 21, f[59]),
                                w = o(w, b, D, T, y, 6, f[60]),
                                T = o(T, w, b, D, B, 10, f[61]),
                                D = o(D, T, w, b, p, 15, f[62]),
                                b = o(b, D, T, w, m, 21, f[63]),
                                u[0] = u[0] + w | 0,
                                u[1] = u[1] + b | 0,
                                u[2] = u[2] + D | 0,
                                u[3] = u[3] + T | 0
                            ...
                            _doFinalize: function() {
                                ...
                                var o = e.floor(i / 4294967296)
                                  , s = i;
                                r[(n + 64 >>> 9 << 4) + 15] = 16711935 & (o << 8 | o >>> 24) | 4278255360 & (o << 24 | o >>> 8),
                                r[(n + 64 >>> 9 << 4) + 14] = 16711935 & (s << 8 | s >>> 24) | 4278255360 & (s << 24 | s >>> 8),
                        ...
                        s.HmacMD5 = u._createHmacHelper(l)
                    }(Math),
                    t.MD5
                })
            }
                          ...
                          , p = a.DES = s.extend({
                            _doReset: function() {
                                ...
                                for (var o = this._subKeys = [], s = 0; s < 16; s++) {
                                    for (var a = o[s] = [], f = h[s], i = 0; i < 24; i++)
                                        a[i / 6 | 0] |= r[(u[i] - 1 + f) % 28] << 31 - i % 6,
                                        a[4 + (i / 6 | 0)] |= r[28 + (u[i + 24] - 1 + f) % 28] << 31 - i % 6;
                                    a[0] = a[0] << 1 | a[0] >>> 31;
                                    for (var i = 1; i < 7; i++)
                                        a[i] = a[i] >>> 4 * (i - 1) + 3;
                                    a[7] = a[7] << 5 | a[7] >>> 27
                                }
                                for (var l = this._invSubKeys = [], i = 0; i < 16; i++)
                                    l[i] = o[15 - i]
                            },
                            encryptBlock: function(t, e) {
                            ...
                            _doCryptBlock: function(t, i, n) {
                                ...
                                for (var o = 0; o < 16; o++) {
                                    for (var s = n[o], a = this._lBlock, c = this._rBlock, u = 0, h = 0; h < 8; h++)
                                        u |= f[h][((c ^ s[h]) & l[h]) >>> 0];
                                    this._lBlock = c,
                                    this._rBlock = a ^ u
                                }
